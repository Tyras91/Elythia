...
monster.loot = {
	...
	{ id = 22118, chance = 100000, maxCount = 18 }, -- tibia coins
}

monster.attacks = {
	{ name = "melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -300 },
	{ name = "combat", interval = 2000, chance = 25, type = COMBAT_EARTHDAMAGE, minDamage = -115, maxDamage = -650, range = 1, radius = 1, effect = CONST_ME_POISONAREA, target = true },
}
