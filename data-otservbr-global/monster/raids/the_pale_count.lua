...
monster.loot = {
	...
	{ id = 22118, chance = 100000, maxCount = 28 }, -- tibia coins
}
...
monster.attacks = {
	...
	{ name = "combat", interval = 2000, chance = 21, type = COMBAT_ICEDAMAGE, minDamage = -130, maxDamage = -1480, range = 6, radius = 2, shootEffect = CONST_ANI_SMALLICE, effect = CONST_ME_GIANTICE, target = true },
