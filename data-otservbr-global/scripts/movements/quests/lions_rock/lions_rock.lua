local signs = {
	{
		...
		message2 = "As a sign of victory he took its eye, yellow as envy and malevolence, and out of a foul creature created a precious treasure.",
	},
	{
		...
		message2 = "As a sign of victory he took its egg, blue as sloth and conceit, and out of a foul creature created a precious treasure.",
	},
	{
		...
		message2 = "As a sign of victory he took its poison, violet as deceit and betrayal, and created a precious treasure.",
	},
	{
		pos = { x = 33127, y = 32340, z = 9 },
		storage = Storage.LionsRock.InnerSanctum.HyenaSign,
		message1 = "With the aid of the old scroll you translate the inscriptions on the golden statue: And the mighty lion defeated the greedy hyena.",
		message2 = "As a sign of victory he took its blood, red as voracity and lust, and created a precious treasure.",
	},
}
...
for _, pos in ipairs(checkPos) do
	lionsRockTranslationScroll:position(pos)
end
...
function lionsRockSigns.onStepIn(creature, item, position, fromPosition)
	...
	for _, setting in ipairs(signs) do
		local pos = player:getPosition()
		if player:getStorageValue(setting.storage) < 1 and
		   player:getItemCount(21467) >= 1 and
		   pos.x == setting.pos.x and
		   pos.y == setting.pos.y and
		   pos.z == setting.pos.z then
...
for _, sign in ipairs(signs) do
	lionsRockSigns:position(sign.pos)
end
