		...
		[11] = {
			...
			missions = {
				...
				[48] = {
					...
					states = {
						[0] = function(player)
							return string.format("You already hunted %d/666 demons.", player:getStorageValue(Storage.Quest.U8_5.KillingInTheNameOf.MonsterKillCount.DemonCount))
						end,
						[1] = "You successfully hunted 666 demons.",
					},
				},
